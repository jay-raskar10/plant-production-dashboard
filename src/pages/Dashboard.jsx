...
import { STATIONS, KPI_DATA, LINE_GRAPH_DATA } from '@/lib/data';
        ...
        >
            ...
            <div className="flex justify-between items-start mb-4">
                <div>
                    ...
                    <p className="text-xs text-muted-foreground mt-1">Operator: {station.operator}</p>
                </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-auto">
                <div className="space-y-1">
                    ...
                    <div className="text-2xl font-mono font-bold tracking-tight">{station.count}</div>
                </div>
                <div className="space-y-1">
                    <span className="text-[10px] uppercase text-muted-foreground font-semibold">Cycle Time</span>
                    <div className="flex items-center gap-1.5">
                        <Clock className="h-3 w-3 text-muted-foreground" />
                        <span className="text-lg font-medium">{station.cycleTime}</span>
                    </div>
                </div>
            </div>
